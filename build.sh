...
ansible-playbook -i inventory cluster.yml -e "bootstrap_os=ubuntu" -e "cloud_provider=openstack" -e "kube_version=v1.5.2" --ssh-extra-args="-o StrictHostKeyChecking=no" --private-key /root/.ssh/k8s -s -u ubuntu
